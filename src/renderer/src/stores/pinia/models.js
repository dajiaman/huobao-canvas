...
import { PROVIDERS, getProviderList, getDefaultProvider, getProviderConfig, getDefaultBaseUrl } from '@renderer/config/providers'
...
export const useModelStore = defineStore('model', () => {
  ...
  // 按渠道存储的自定义模型 | 结构: { 'openai': [{key, label}], 'volcengine': [{key, label}] }
