...
class ObjectRefImpl {
  constructor(_object, key, _defaultValue) {
    ...
    let shallow = true;
    let obj = _object;
    if (!isArray$2(_object) || isSymbol$1(this._key) || !isIntegerKey(this._key)) {
      do {
...
const mousePositionRef = /* @__PURE__ */ ref(null);
...
const clickedTimeRef = /* @__PURE__ */ ref(void 0);
let usedCount = 0;
...
function useClicked(timeout) {
  if (!isBrowser$3)
    return /* @__PURE__ */ readonly(/* @__PURE__ */ ref(false));
  const clickedRef = /* @__PURE__ */ ref(false);
  let timerId = null;
  function clearTimer() {
    if (timerId !== null)
...
const lockHtmlScrollRightCompensationRef = /* @__PURE__ */ ref("0px");
...
const NBaseIcon = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    useStyle("-base-icon", style$9, /* @__PURE__ */ toRef(props, "clsPrefix"));
  },
  render() {
    return h("i", {
...
const NBaseClose = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    useStyle("-base-close", style$8, /* @__PURE__ */ toRef(props, "clsPrefix"));
    return () => {
      const {
        clsPrefix,
        disabled,
...
const NBaseLoading = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    useStyle("-base-loading", style$7, /* @__PURE__ */ toRef(props, "clsPrefix"));
  },
  render() {
    const {
      clsPrefix,
...
const NBaseWave = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    useStyle("-base-wave", style$5, /* @__PURE__ */ toRef(props, "clsPrefix"));
  ...
  setup(props) {
    ...
    const {
      ...
      mergedSize: (NFormItem) => {
        ...
        const configSize = (_b = (_a = mergedComponentPropsRef === null || mergedComponentPropsRef === void 0 ? void 0 : mergedComponentPropsRef.value) === null || _a === void 0 ? void 0 : _a.Button) === null || _b === void 0 ? void 0 : _b.size;
...
const style$3 = c([cB("card", `
...
}), cM("hoverable", [c("&:hover", "box-shadow: var(--n-box-shadow);")]), cM("content-segmented", [c(">", [cB("card-content", `
 padding-top: var(--n-padding-bottom);
 `), cE("content-scrollbar", [c(">", [cB("scrollbar-container", [c(">", [cB("card-content", `
 padding-top: var(--n-padding-bottom);
 `)])])])])])]), cM("content-soft-segmented", [c(">", [cB("card-content", `
 ...
 `), contentBaseStyle, cB("card-content", [c("&:first-child", `
 padding-top: var(--n-padding-bottom);
 `)]), cE("content-scrollbar", `
 display: flex;
 flex-direction: column;
 `, [c(">", [cB("scrollbar-container", [c(">", [contentBaseStyle])])]), c("&:first-child >", [cB("scrollbar-container", [c(">", [cB("card-content", `
 padding-top: var(--n-padding-bottom);
 `)])])])]), cE("footer", `
 box-sizing: border-box;
 padding: 0 var(--n-padding-left) var(--n-padding-bottom) var(--n-padding-left);
 ...
 `)])])]), cM("content-segmented, content-soft-segmented", [c(">", [cB("card-content", `
...
const NCard = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    ...
    const mergedSizeRef = computed(() => {
      var _a, _b;
      return props.size || ((_b = (_a = mergedComponentPropsRef === null || mergedComponentPropsRef === void 0 ? void 0 : mergedComponentPropsRef.value) === null || _a === void 0 ? void 0 : _a.Card) === null || _b === void 0 ? void 0 : _b.size) || "medium";
    });
    const cssVarsRef = computed(() => {
...
const NModalBodyWrapper = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    ...
    const displayedRef = /* @__PURE__ */ ref(props.show);
    const transformOriginXRef = /* @__PURE__ */ ref(null);
    const transformOriginYRef = /* @__PURE__ */ ref(null);
    ...
    const {
      ...
      draggableRef,
      draggableClassRef
    } = useDragModal(/* @__PURE__ */ toRef(props, "draggable"), {
      onEnd: (el) => {
    ...
    const childNodeRef = /* @__PURE__ */ ref(null);
...
const NModal = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    ...
    provide(modalInjectionKey, {
      ...
      isMountedRef,
      appearRef: /* @__PURE__ */ toRef(props, "internalAppear"),
      transformOriginRef: /* @__PURE__ */ toRef(props, "transformOrigin")
    });
    const cssVarsRef = computed(() => {
      const {
        common: {
...
const NDialogProvider = /* @__PURE__ */ defineComponent({
  ...
  setup() {
    const dialogListRef = /* @__PURE__ */ ref([]);
    const dialogInstRefs = {};
    function create(options = {}) {
      const key = createId();
      const dialogReactive = /* @__PURE__ */ reactive(Object.assign(Object.assign({}, options), {
        key,
        destroy: () => {
          var _a;
...
const isDark = /* @__PURE__ */ ref(getInitialTheme());
watch(
  isDark,
  (value) => {
...
export {
  ...
  cB as M,
  NModal as N,
  fadeInTransition as O,
  fadeInScaleUpTransition as P,
  cNotM as Q,
  NBaseIcon as R,
  LazyTeleport as S,
  zindexable as T,
  ...
  markRaw as aG,
  readonly as aH,
  resolveComponent as aI,
  normalizeProps as aJ,
  useRoute as aK,
  isBrowser$3 as aL,
  hasInstance as aM,
  useMemo as aN,
  modalBodyInjectionKey as aO,
  drawerBodyInjectionKey as aP,
  popoverBodyInjectionKey as aQ,
  getSlot as aR,
  getFirstVNode as aS,
  CssRender as aT,
  useSsrAdapter as aU,
  VResizeObserver as aV,
  onActivated as aW,
  onDeactivated as aX,
  resizeObserverManager as aY,
  isSymbol as aZ,
  isObject as a_,
  createKey as aa,
  cE as ab,
  ...
  isSlotEmpty as ad,
  resolveWrappedSlot as ae,
  useFormItem as af,
  NIconSwitchTransition as ag,
  depx as ah,
  createStaticVNode as ai,
  effectScope as aj,
  useSlots as ak,
  onUnmounted as al,
  renderSlot as am,
  getCurrentInstance as an,
  getCurrentScope as ao,
  onScopeDispose as ap,
  createPropsRestProxy as aq,
  useAttrs as ar,
  mergeProps as as,
  ...
  toSource as b8,
  Map$1 as b9,
  getPreciseEventTarget as bA,
  getFirstSlotVNode as bB,
  cloneVNode as bC,
  Text as bD,
  keep as bE,
  commonVariables$k as bF,
  NBaseClose as bG,
  color2Class as bH,
  Wrapper as bI,
  internalSelectionLight as bJ,
  commonVars$b as bK,
  fadeInHeightExpandTransition as bL,
  NFadeInExpandTransition as bM,
  ErrorIcon as bN,
  WarningIcon as bO,
  InfoIcon as bP,
  SuccessIcon as bQ,
  scrollbarLight as bR,
  commonVariables$i as bS,
  resolveSlotWithTypedProps as bT,
  isSafari as bU,
  markEventEffectPerformed as bV,
  selectLight as bW,
  warn as bX,
  iconLight as bY,
  dropdownLight as bZ,
  ...
  baseFor as bl,
  arrayMap as bm,
  configProviderInjectionKey as bn,
  resolveSlot as bo,
  useStyle as bp,
  emptyLight as bq,
  render as br,
  ...
  formLight as c0,
  commonVariables$n as c1,
  createId as c2,
  formItemInjectionKey as c3,
  omit as c4,
  flatten as c5,
  TransitionGroup as c6,
  tabsLight as c7,
  defineStore as c8,
  toggleTheme as c9,
  isDark as ca,
